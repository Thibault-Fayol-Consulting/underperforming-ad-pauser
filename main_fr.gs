...
function main() {
    Logger.log("Évaluation des annonces gagnantes et perdantes...");
    ...
    while(agIter.hasNext()) {
        ...
        if (ads.length >= CONFIG.MIN_ADS) {
            ...
            if (worst.cpa > ads[0].cpa * 1.5) { 
                Logger.log("Mise en pause de la pire annonce dans " + ag.getName() + " (CPA: " + worst.cpa.toFixed(2) + ")");
